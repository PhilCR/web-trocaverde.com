...
function validarCadastroAdmin() {    
    ...
    var senha2 = document.getElementById("senharep").value;
...
function validarCadLoja() {            
    ...
    var nfantasia = document.getElementById("nfantasia").value;
    var razaoSocial = document.getElementById("rsocial").value;
    var cnpj = document.getElementById("cnpj").value;
    var ie = document.getElementById("insc_est");
    ...
    var estado = document.getElementById("txt_end_est").value;
    ...
    if (ieStatus != "") { //IE - Caso necessário
