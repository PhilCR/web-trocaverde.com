	...
	<div id="content" align="center" class="container alert alert-info visible-desktop visible-tablet hidden-phone" style="margin-bottom:0px;padding: 0px 0px 0px 0px; min-height: 300px;">
		...
		<div id="div_p" style="display:none;"><form class="row-fluid" action="enviar_cadastro_pontuador.php" name="form_cadastro_pontuador" method="post">
			...
			<div class="span5 input-append">
				...
				<input type="text" class="input-large" name="txt_email" id="email" size="50" maxlength="70" placeholder="Digite o Email" required/><abbr title="Preencha com o e-mail padrão no formato email@dominio.ext."><span class="add-on"><i class="icon-asterisk"></i></span></abbr></br>
				...
				<input type="password" class="input-large" name="txt_re_senha" id="senharep" size="50" maxlength="16" placeholder="Repita a Senha" required/><abbr title="Digite novamente a senha escolhida."><span class="add-on"><i class="icon-asterisk"></i></span></abbr></br>
			</div>
			<div class="span5 input-append">
				<h4>Informações Pessoais</h4>
				<input type="text" class="input-large" name="txt_nome" id="nome" size="50" maxlength="200" placeholder="Digite o Nome" required/><abbr title="Insira o nome." required><span class="add-on"><i class="icon-asterisk"></i></span></abbr></br>
				<input type="text" class="input-large" name="txt_snome" id="snome" size="50" maxlength="50" placeholder="Digite o Sobrenome" required/><abbr title="Insira o sobrenome."><span class="add-on"><i class="icon-asterisk"></i></span></abbr></br>
				<input type="text" class="input-large" name="txt_tel" id="telefone" size="50" maxlength="11" placeholder="Digite o Telefone" required/><abbr title="Insira o telefone, somente números"><span class="add-on"><i class="icon-asterisk"></i></span></abbr></br>
				<input class="btn btn-info btn-small" type="button" name="btn_cadastrar" id="enviar_cad_pont" value="Cadastrar" onclick="validarCadPontuador" />
		...
		<div id="div_a" style="display:none;"><form action="enviar_cadastro_admin.php" name="form_cadastro_admin" method="post">
			...
			<div class="span5 input-append">
				<h4>Informações Pessoais</h4>
				<input type="text" class="input-large" name="txt_nome" id="nome" size="50" maxlength="200" placeholder="Digite o Nome" required/><abbr title="Insira o nome." required><span class="add-on"><i class="icon-asterisk"></i></span></abbr></br>
				<input type="text" class="input-large" name="txt_snome" id="snome" size="50" maxlength="50" placeholder="Digite o Sobrenome" required/><abbr title="Escolha uma senha de 6 à 16 dígitos. Prefira senha com números e letra, para maior segurança."><span class="add-on"><i class="icon-asterisk"></i></span></abbr></br>
				<input type="text" class="input-large" name="txt_tel" id="telefone" size="50" maxlength="11" placeholder="Digite o Telefone" required/><abbr title="Insira o telefone, somente números"><span class="add-on"><i class="icon-asterisk"></i></span></abbr></br>
				<input class="btn btn-info btn-small" type="button" name="btn_cadastrar" id="enviar_cad_admin" value="Cadastrar" onclick="validarCadastroAdmin()" />
                <button style="display:none;" type="submit" id="btn_cadastrar2" name="btn_cadastrar"></button>
			</div>
		</form></div>
	</div>        
